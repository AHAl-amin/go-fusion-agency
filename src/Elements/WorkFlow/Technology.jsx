  ...
  return (
    <figure
      className={cn(
        ...
        "border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gradient-to-r from-orange-200  to-orange-300 transition-all duration-500",
...
export function Technology() {
  return (
    <div className="md:py-10 relative bg-[#160306] dark:bg-black flex w-full flex-col items-center justify-center overflow-hidden">
