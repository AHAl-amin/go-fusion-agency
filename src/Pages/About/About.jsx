...
export default function About() {
  ...
  return (
    <div className="relative min-h-screen bg-[#160306] dark:bg-black overflow-hidden">
      {/* Grid Background */}
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-3 bg-gradient-to-r   from-orange-200 via-orange-300 to-[#195022cb] text-transparent bg-clip-text">
              About Us
            </h2>
            <p className="text-white text-[17px] max-w-3xl mx-auto">
              At{" "}
              <span className="text-[20px] font-semibold bg-gradient-to-r  from-orange-200 to-orange-300 text-transparent bg-clip-text">
                GO FUSION 
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="p-6 hover:shadow-md border-r-5 border-orange-200 hover:border-r-5 hover:border-orange-100 hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000"
              >
            ...
            {/* Final Custom Card */}
            <Card className="p-6 col-span-1 md:col-span-2 lg:col-span-1   border-r-5 border-orange-200  hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000">
              <CardContent className="p-0">
