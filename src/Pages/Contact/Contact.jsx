...
const Contact = () => {
  return (
    <div className="relative min-h-screen py-16 px-4 bg-[#160306] dark:bg-black overflow-hidden">
      {/* Grid Background */}
      ...
      <div className="relative z-10 container mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r  from-orange-200 via-orange-300 to-[#195022cb] text-transparent bg-clip-text dark:text-white mb-4">
            Get In Touch
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="cursor-pointer border  dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg text-center border-r-5 border-orange-200 hover:border-r-5 hover:border-orange-100 hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000">
          ...
          <Card className="cursor-pointer border border-r-5 border-orange-200 hover:border-r-5 hover:border-orange-100 hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000 dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg text-center">
            <CardContent className="pt-6">
          ...
          <Card className="border border-r-5 border-orange-200 hover:border-r-5 cursor-pointer hover:border-orange-100 hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000 dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg text-center">
            <CardContent className="pt-6">
          ...
          <Card className="border border-r-5 border-orange-200 hover:border-r-5 hover:border-orange-100 hover:bg-gradient-to-r  from-orange-200 to-orange-300  group transition-all duration-1000 cursor-pointer dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg text-center">
            <CardContent className="pt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* FAQ Section */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r  from-orange-200 via-orange-300 to-[#195022cb] text-transparent bg-clip-text dark:text-white mb-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg ">
              ...
              <CardContent className="space-y-4">
                ...
                />
                <button className='"w-full text-lg font-medium flex justify-center gap-2 mt-2  text-[#010231]] w-3/5 py-[6px] rounded-md mx-auto bg-gradient-to-r   from-orange-200 to-orange-300 cursor-pointer'>
                  Contact
                </button>
              </CardContent>
            </Card>
            ...
            <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-900 shadow-lg">
              ...
              <CardContent>
                <Button
                  asChild
                  className="w-full text-lg font-medium flex justify-center gap-2 mt-2 bg-gradient-to-r  from-orange-200 to-orange-300 "
                  variant="default"
                >
                  <a
