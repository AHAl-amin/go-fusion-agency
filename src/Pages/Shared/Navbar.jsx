...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full backdrop-blur-md bg-[#160306] dark:bg-black  border-gray-200 px-3   dark:border-gray-800">
      <div className="container mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            ...
            >
              <p className="bg-gradient-to-r  from-orange-200 to-orange-300 text-transparent bg-clip-text">GO FUSION</p>
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-10">
              ...
              <Button
                size="lg"
                className="relative overflow-hidden bg-gradient-to-r from-orange-200 to-orange-300  dark:bg-white text-[#010231] dark:text-black py-5 text-[16px] font-semibold rounded-md shadow-lg hover:shadow-gray-500/50 transition-all duration-500 group"
              >
                <a
